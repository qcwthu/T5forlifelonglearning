learnrate=(5e-1)
#allewclambda=(0.1 0.05 0.01)
#allewclambda=(0.1 0.01 0.001)
allewclambda=(0.1)
...
do
  ...
  do
      echo "------------------------------"
        python -m torch.distributed.launch --nproc_per_node 1 --master_port 29602 PromptEWC.py \
          --cuda 1 \
          --lr $onerate \
    ...
    echo "++++++++++++++++++++++++++++++"
    ps aux | grep PromptEWC.py | awk '{print $2}' | xargs kill -9
  done
done
