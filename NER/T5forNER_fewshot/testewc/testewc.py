...
def gen_fisher(model, pre_dataloader):
    fisher = None
    model.eval()
...
if __name__ == "__main__":
    ...
    if args.model == "T5NER":
        ...
        t5conllckpt = torch.load("../testfinetune/t5ner_ckpt/t5ner_ckpt/ckptofT5ner_best")
    ...
    train_pre_file_name = "./conll_fewshot/train.txt"
    #ewc_lambda = 1000.0  ####which one is suitable?
    #ewc_lambda = 100.0
    #ewc_lambda = 500.0
    #ewc_lambda = 1000.0
    ewc_lambda = args.ewc_lambda
    logger.info(ewc_lambda)
    previous_data_set = T5NERDatasetConll(train_pre_file_name, args.max_length, tokenizer)
    ...
    #print(grad_mean)
    grad_fisher = gen_fisher(model, pre_dataloader)
    #print(grad_fisher)
    #print(grad_fisher)
