...
def test_generation(args, test_dataset):
    ...
    #outfilename = 'pseudosamples_' + args.save_dir
    outfilename = 'pseudosamples'
        ...
        for step, batch in enumerate(test_dataloader):
            ...
            if scaler is not None:
                with autocast():
                    ...
                    #print(preds)
                    for aa in preds:
                        if "__ans__" in aa and '!' in aa:
                            if 'org' in aa or 'location' in aa or 'person' in aa or 'mix' in aa:
                                print(aa)
                                f.write(aa+"\n")
                    #print("---------------------")
            else:
...
if __name__ == "__main__":
    ...
    if args.local_rank in [0, -1]:
        ...
        test_generation(args,test_dataset)
