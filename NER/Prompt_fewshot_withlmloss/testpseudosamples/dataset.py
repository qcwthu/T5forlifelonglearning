...
class T5NERDatasetConll(Dataset):
    def __init__(self, filename, maxlen, tokenizer,allgentoken, answertoken):
        ...
        self.allgentoken = allgentoken  ####list
    ...
    def getalldata(self,filename):
        ...
        while True:
            ...
            if len(linelist) != 3:
                print(oneline)
                print(linelist)
            datatype = int(linelist[0])
            #if datatype == 0:
            #    print(datatype)
            if datatype < self.currenttasknumber:
                ifmem.append(0) ######mem
            else:
                ifmem.append(1)
            onedata = []
            ...
            ####lmdata
            onelmdata = []
            onelmdata.append(self.allgentoken[datatype])
