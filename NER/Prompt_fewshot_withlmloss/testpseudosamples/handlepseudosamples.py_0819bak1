...
if __name__ == "__main__":
    ...
    parser.add_argument("--seed", dest="seed", type=int,
                        default=142, help="seed for network")
    ...
    if args.model == "T5":
        ...
        print("right!")
        ###loc:9 org 6 person 7 mix 6 valid
        ###loc:9 org 7 person 8 mix 6 train
        #allnumber = {'org':15,'location':14,'person':11,'mix':9}
        #trainnumber = {'org':7,'location':8,'person':5,'mix':4}
        allnumber = {'org':13,'location':18,'person':15,'mix':12}
        trainnumber = {'org':7,'location':9,'person':8,'mix':6}
        #validnumber = {'org': 8, 'location': 6, 'person': 6, 'mix': 5}
