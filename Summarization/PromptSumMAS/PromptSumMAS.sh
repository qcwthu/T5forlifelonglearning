...
#alllambda=(0.25)
#allewclambda=(0.001)
#allewclambda=(0.01 0.005 0.002 0.0005 0.02)
#allewclambda=(0.02 0.0002 0.05)
#allewclambda=(0.001 0.01 0.005 0.002 0.0005 0.02 0.0002 0.05)
allewclambda=(0.005 0.002 0.0005 0.02 0.0002 0.05)
allstartindex=(0 1 2)
alltask=(0 1 2)
...
do
  ...
  do
    ...
    do
      ...
      do
              echo "------------------------------"
              python -m torch.distributed.launch --nproc_per_node 1 --master_port 29908 PromptSumMAS.py \
                --cuda 3 \
                --lr $onerate \
                ...
                --ifckpt_onlymodel 1
              echo "++++++++++++++++++++++++++++++"
              ps aux | grep PromptSumMAS.py | awk '{print $2}' | xargs kill -9
      done
    done
  done
done
