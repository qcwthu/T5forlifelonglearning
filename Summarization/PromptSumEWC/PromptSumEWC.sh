...
#alllambda=(0.25)
#allewclambda=(0.1)
#allewclambda=(0.2 0.05 0.03 0.01 0.005)
#allewclambda=(0.1 0.2 0.05 0.03 0.01 0.005)
allewclambda=(0.1)
#allstartindex=(0 1 2)
#alltask=(0 1 2)
allstartindex=(2)
...
do
  ...
  do
    ...
    do
      ...
      do
              echo "------------------------------"
              python -m torch.distributed.launch --nproc_per_node 1 --master_port 29907 PromptSumEWC.py \
                --cuda 6 \
                --lr $onerate \
                ...
                --ifckpt_onlymodel 1
            echo "++++++++++++++++++++++++++++++"
            ps aux | grep PromptSumEWC.py | awk '{print $2}' | xargs kill -9
      done
    done
  done
done
