...
def main():
    ...
    parser.add_argument("--logs_dir", default="../models/T5-large-ft", type=str, required=False)
    parser.add_argument("--output_file", default="../allres/pt_res_ft.csv", type=str, required=False)
