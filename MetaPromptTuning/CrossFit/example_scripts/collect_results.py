...
def main():
    ...
    parser.add_argument("--logs_dir", default="../models/T5-large-maml", type=str, required=False)
    parser.add_argument("--output_file", default="../allres/pt_res-maml.csv", type=str, required=False)
