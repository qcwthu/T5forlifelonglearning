...
class T5SummarizationDataset(Dataset):
    def __init__(self, filename, maxlen, tokenizer,gentasktoken, answertoken):
        #allgentasktoken = ["summerizationcnndm", "classifyagnews", "__nerco__"]
        super(T5SummarizationDataset, self).__init__()
        self.filename = filename
        self.maxlen = maxlen
        self.tokenizer = tokenizer
        self.data = []
        self.gentasktoken = gentasktoken ##list
    ...
    def getalldata(self,filename):
        ...
        while True:
            ...
            ####depends on the data
            tousegen = ""
            if "Find out all name entities" in linelist[0]:
                tousegen = "__nerco__"
            elif "Classify the sentence" in linelist[0]:
                tousegen = "classifyagnews"
            elif "Summarize this sentence" in linelist[0]:
                tousegen = "summarizationcnndm"
            else:
                print("error!!!!!!!!")
            #print(tousegen)
            onelmdata.append(tousegen)
